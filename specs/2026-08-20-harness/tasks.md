...
- [ ] Add a bounded record of prior-phase actions to cross-phase state so a later phase can tell whether a Tool was already called. Carry calls only, never result bodies: per prior phase, `action_kind`, `identity`, a short argument digest, and a normalized completion status.
